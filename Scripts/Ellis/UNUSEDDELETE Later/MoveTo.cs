...
public class MoveTo : MonoBehaviour
{
    ...
    public bool patrolRoute1, patrolRoute2, patrolRoute3; public bool called;
    ...
    //NavMeshAgent agent; //reference to an object with NavMeshAgent agent, set it in inspector, for example
        ...
        public void opener()
    {
        ainav ainaveq = ainave.GetComponent<ainav>();
        ...
        foreach (GameObject obj in tempArray)
        {
            ...
            newLocation();
            //ainav nav = ainave.GetComponent<ainav>();
            //ainave.goal = goal;
        ...
        {
            newLocation();
            n.gameObject.GetComponent<ainav>().goal = goal;
            goal = null;
            ainaveq.ready = true;
        }
    }
